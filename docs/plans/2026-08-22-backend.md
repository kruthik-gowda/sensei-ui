...
Note steps 2–4 resolve the apparent contradiction between the second and fourth
tests: signatures are *derived* from sensei's tuple helpers and then serialised.
